...
{
    public Guid Id { get; set; } = Guid.NewGuid(); public Guid TenantId { get; set; }
    /// <summary>Outbound/staged uploads name the uploading user; inbound media has no user uploader.</summary>
    ...
    /// <summary>Provider media id for inbound media; persisted privately and never exposed on attachment DTOs.</summary>
