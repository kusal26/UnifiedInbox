...
public sealed class InvitationService(InboxDbContext db, ICurrentTenant current, IPasswordHasher<User> passwords, IMailSender mail, ITenantExecutionScope? executionScope = null) : IInvitationService
{
